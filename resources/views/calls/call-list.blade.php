...
@section('content')
    ...
    <body class="bg-light">
                    ...
                    <div class="card">
                                    ...
                                    <div class="dropdown d-inline-block">
                                        ...
                                        <div class="dropdown-menu dropdown-menu-right">
                                            <div class="px-3 py-2">
                                                ...
                                                <div class="custom-control custom-checkbox mb-2">
                                                    <input type="checkbox" class="custom-control-input" id="call_duration_seconds"
                                                        checked>
                                                    <label class="custom-control-label" for="call_duration_seconds">Call Duration</label>
                                                </div>
                                                <div class="custom-control custom-checkbox mb-2">
                                                    <input type="checkbox" class="custom-control-input" id="from_number"
                                                        checked>
                                                    <label class="custom-control-label" for="from_number">From Number</label>
                                                </div>
                                                <div class="custom-control custom-checkbox mb-2">
                                                    <input type="checkbox" class="custom-control-input" id="to_number"
                                                        checked>
                                                    <label class="custom-control-label" for="to_number">To Number</label>
                                                </div>
                                                <div class="custom-control custom-checkbox mb-2">
                                                    <input type="checkbox" class="custom-control-input" id="direction"
                                                        checked>
                                                    <label class="custom-control-label" for="direction">Direction</label>
                                                </div>
                                                <div class="custom-control custom-checkbox mb-2">
                        ...
                        <div class="card-body p-3">
                            <div class="table-responsive">
                                <table class="table table-bordered mb-0 table-hover" id="callLogsTable">
                                    <thead>
                                        <tr>
                                            ...
                                            <th class="text-center" id="call_duration_seconds">Call Duration</th>
                                            <th class="text-center" id="from_number">From Number</th>
                                            <th class="text-center" id="to_number">To Number</th>
                                            <th class="text-center" id="direction">Direction</th>
        ...
        <div id="conversationPanel" class="conversation-panel">
            ...
            <div class="audio-player">
                ...
                <!-- Download Button -->
                <a id="downloadLink" download="recorded_call.ogg">
    ...
    <script>
        // Dynamic Audio URL
    const audioUrl = "https://obd.phonecall_6798629a45698c4bfeae5972_agent_6797117845698c4bfeae58dc-2025-01-28T045249.ogg";

// Get the audio player and download link elements
const audioPlayer = document.getElementById("audioPlayer");
const downloadLink = document.getElementById("downloadLink");

// Set the audio source dynamically
audioPlayer.innerHTML = `<source src="${audioUrl}" type="audio/ogg">`;
...
downloadLink.href = audioUrl;
        ...
        function updateTable(calls) {
            ...
            calls.forEach(call => {
                ...
                <td class="text-center">${call.call_duration_seconds}</td>
                <td class="text-center">${call.from_number}</td>
                <td class="text-center">${call.to_number}</td>
                <td class="text-center">${call.direction}</td>
                ...
                <td >
                    <div class="d-flex justify-content-center ">
                        <button class="btn btn-info btn-sm mr-2" onclick="showConversation('${call._id}')">Show</button>
        ...
        function applyChanges() {
            const fields = ["callid", "agentid", "status", "type", "reason", "callduration", "fromnumber", "tonumber", "direction", "starttime", "endtime", "conversation"];
